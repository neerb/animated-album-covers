...
function Bar({ amplitude, aniDelay, aniDur }) {
    return <div className="bar bar-refactor-solo" style={{ height: amplitude + '%', animationDelay: aniDelay + "ms", animationDuration: aniDur + "ms" }}></div>
}
...
function MusicBumper(props) {
    return (
        <div className="bumper-wrap-refactor-solo">
